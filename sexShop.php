...
<head>
    ...
    <!-- TÍTULO DA PÁGINA -->
    <title>Site de vendas Fernanda ZD Modas - Sex shop</title>
...
<body>
        ...
        <header class="cabecalho">
            ...
            <ul class="menu">
                ...
                <li class="sexShop hover"><a href="sexShop.html" title="Link para a página de produtos de sex shop">Sex shop</a></li>
