...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Cliente` (
  ...
  INDEX `fk_Cliente_Conta1_idx` (`Conta_idConta` ASC) VISIBLE,
  INDEX `fk_Cliente_Telefone1_idx` (`Telefone_idTelefone` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Pedido` (
  ...
  INDEX `fk_Pedido_Cliente1_idx` (`Cliente_idCliente` ASC, `Cliente_Conta_idConta` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Produto` (
  ...
  INDEX `fk_Produto_Estação1_idx` (`Estação_idEstação` ASC) VISIBLE,
  INDEX `fk_Produto_Fabricante1_idx` (`Fabricante_idFabricante` ASC) VISIBLE,
  INDEX `fk_Produto_Tecido1_idx` (`Tecido_idTecido` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Pagamento_has_TipoPagamento` (
  ...
  INDEX `fk_Pagamento_has_TipoPagamento_TipoPagamento1_idx` (`TipoPagamento_idTipoPagamento` ASC) VISIBLE,
  INDEX `fk_Pagamento_has_TipoPagamento_Pagamento1_idx` (`Pagamento_idPagamento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Carrinho_has_Produto` (
  ...
  INDEX `fk_Carrinho_has_Produto_Carrinho1_idx` (`Carrinho_idCarrinho` ASC, `Carrinho_Cliente_idCliente` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `BD_FernandaZDModas`.`Produto_has_Tamanho` (
  ...
  INDEX `fk_Produto_has_Tamanho_Tamanho1_idx` (`Tamanho_idTamanho` ASC) VISIBLE,
  INDEX `fk_Produto_has_Tamanho_Produto1_idx` (`Produto_idProduto` ASC) VISIBLE,
