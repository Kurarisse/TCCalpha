...
<head>
    ...
    <!-- TÍTULO DA PÁGINA -->
    <title>Site de vendas Fernanda ZD Modas - Cosméticos</title>
...
<body>
        ...
        <header class="cabecalho">
            ...
            <ul class="menu">
                ...
                <li class="cosmeticos hover"><a href="cosmeticos.html" title="Link para a página de produtos de cosméticos">Cosméticos</a></li>
