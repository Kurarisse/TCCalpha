...
<body>
        ...
        <header class="cabecalho">
            ...
            <ul class="menu">
                ...
                <li class="cadastro hover"><a href="cadastro.html" title="Link para a página de cadastro">Cadastro</a></li>
        ...
        <!-- VERIFICAR COMO FAZ .BLANK COM PÁGINAS SEM PHP (como o login do google) -->
